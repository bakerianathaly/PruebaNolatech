...
export const detalleEmpleado = async (req, res) => {
    ...
    if(!existingEmployees){
        ...
        let datos= {
            //JSON de los datos del empleado que seran retornados
            id:existingEmployees.id,
            name: existingEmployees.name,
            lastName: existingEmployees.lastName,
            dni: existingEmployees.email,
            email: existingEmployees.role,
            department: existingEmployees.username,
            yearsExperience: existingEmployees.yearsExperience,
            educationInfo: existingEmployees.educationInfo,
            pastJobsInfo: existingEmployees.pastJobsInfo
        }
